		...
		updateWheel: function(sliderIndex, data){
	    	...
	    	if(_this.cascade){
				...
				for(var j=0; j<data.length; j++){
					// console.log(sliderIndex, j, _this.keyMap.value)
					tempHTML += '<li class="wheelItem wheelitem-'+_this.iden+'" id="wheelItem-'+_this.iden+'-'+sliderIndex+'-'+j+'" data-id="'+data[j][_this.keyMap.id]+'">'+data[j][_this.keyMap.value]+'</li>';
				}
				_this.wheelsData[sliderIndex] = {data: data};
	    	}else{
				for(var j=0; j<data.length; j++){
					tempHTML += '<li class="wheelItem wheelitem-'+_this.iden+'" id="wheelItem-'+_this.iden+'-'+sliderIndex+'-'+j+'">'+data[j]+'</li>';
				}
